...
![Branches and Tags Mapping]({{ site.baseurl }}/img/remotebook/default_layout_config.png)
...
![Branches and Tags Mapping]({{ site.baseurl }}/img/remotebook/layout_config_no_branches.png)]
...
This is what was changed in SVN repository:
    ...
    ------------------------------------------------------------------------
    r20 | vadishev | 2015-07-29 18:04:09 +0700 (Wed, 29 Jul 2015) | 1 line
...
In this case following revisions will appear. The changes that were made in the branch, branch merge, and changes that were made in the master:
    ...
    ------------------------------------------------------------------------
    r25 | vadishev | 2015-07-29 20:17:58 +0700 (Wed, 29 Jul 2015) | 1 line

    important change
    ------------------------------------------------------------------------
    r24 | vadishev | 2015-07-29 20:17:11 +0700 (Wed, 29 Jul 2015) | 1 line

    Merge branch 'bar'
    ------------------------------------------------------------------------
    r23 | vadishev | 2015-07-29 20:13:02 +0700 (Wed, 29 Jul 2015) | 1 line
...
Then change something in master, commit it and push. Please note that this time not only master is being pushed, but the branch "gar" explicitly:
    ...
    [master 623bf69] change in master 3
     1 file changed, 1 insertion(+), 1 deletion(-)
...
The result of that is as follows, new branch has been created in SVN repository:
    ...
    ------------------------------------------------------------------------
    r38 | vadishev | 2015-07-29 22:17:23 +0700 (Wed, 29 Jul 2015) | 1 line

    Branch '/branches/gar' created from /trunk:36
    ------------------------------------------------------------------------
    r37 | vadishev | 2015-07-29 22:17:23 +0700 (Wed, 29 Jul 2015) | 1 line

    change in master 3
    ------------------------------------------------------------------------
    r36 | vadishev | 2015-07-29 22:15:54 +0700 (Wed, 29 Jul 2015) | 1 line
...
![Branches and Tags Mapping]({{ site.baseurl }}/img/remotebook/complicated_layout_url.png)][]

Configuration file would be looking like this in that case:

![Branches and Tags Mapping]({{ site.baseurl }}/img/remotebook/complicated_layout.png)][]
...
And of course it will appear in the log of corresponding SVN repository:
    ...
    ------------------------------------------------------------------------
    r55 | vadishev | 2015-07-30 03:10:30 +0700 (Thu, 30 Jul 2015) | 1 line
...
It will be translated to the SVN repository as branch named "release_AB"
    ...
    ------------------------------------------------------------------------
    r56 | vadishev | 2015-07-30 04:13:16 +0700 (Thu, 30 Jul 2015) | 1 line
...
If it's changed by adding already existing (or was existing ever before) in SVN repository branches 

![Branches and Tags Mapping]({{ site.baseurl }}/img/remotebook/already_existing_branch.png)
...
If there was no such branch in SVN repository, it will be created, and you will be able to work with it as it was shown in previous cases.
...
In case there is a branch with the specific name space, that exists only in your Git repository, like that:
...
![Branches and Tags Mapping]({{ site.baseurl }}/img/remotebook/great_branch_config.png)
...
and run **subgit install**. It will become available in your SVN repository after that:
    ...
    ------------------------------------------------------------------------
    r57 | vadishev | 2015-07-30 05:14:00 +0700 (Thu, 30 Jul 2015) | 1 line
